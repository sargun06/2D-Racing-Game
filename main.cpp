...
void firstDesign(){
      ...
      glColor3f(0.133, 0.545, 0.133);
        ...
        glColor3f(1.000, 1.000, 1.000);
        renderBitmapString(30,50-6+10,(void *)font3,"Press UP DOWN LEFT RIGHT keys");
}
